 ...
 */
final class Version20240531175015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book_to_book_format (id INT NOT NULL, price NUMERIC(10, 2) NOT NULL, discount_percent INT DEFAULT NULL, book VARCHAR(255) DEFAULT NULL, format VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE review (id INT NOT NULL, book_id INT NOT NULL, rating INT NOT NULL, author VARCHAR(255) NOT NULL, created_at DATE NOT NULL, PRIMARY KEY(id))');
